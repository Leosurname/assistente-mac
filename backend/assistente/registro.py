...
def configurar(nivel: str | None = None) -> None:
    ...
    Nada de transcricao em log por padrao: o que o usuario fala e conteudo
    dele, e um arquivo de log e o lugar mais facil de vazar isso sem querer.
    Em DEBUG o texto aparece, e ai a escolha e de quem ligou o DEBUG.
    """
